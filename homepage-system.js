...
(async()=>{
  ...
  try{
    ...
    app.innerHTML='<div class="ma-home-wrap"><section class="ma-home-section"><div class="ma-home-heading"><div><span>LATEST RELEASES</span><h2>Latest Chapters</h2><p>Newest posted or updated chapter from each manga.</p></div><a href="/latest-chapters.html">View all →</a></div><div class="ma-home-grid">'+latest.slice(0,10).map(card).join('')+'</div></section><section class="ma-home-section"><div class="ma-home-heading"><div><span>RECENT ACTIVITY</span><h2>More Latest Chapters</h2></div></div><div class="ma-home-list">'+latest.slice(0,18).map(list).join('')+'</div></section></div>';
